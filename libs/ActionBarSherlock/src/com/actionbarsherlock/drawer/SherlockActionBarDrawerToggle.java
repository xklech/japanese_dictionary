...
package com.actionbarsherlock.drawer;
...
public class SherlockActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    private static class ActionBarDrawerToggleImplCompat implements ActionBarDrawerToggleImpl {
        ...
        public Drawable getThemeUpIndicator(Activity activity) {
        	return com.actionbarsherlock.drawer.SherlockActionBarDrawerToggleCompat.getThemeUpIndicator(activity);
        }

        @Override
        public Object setActionBarUpIndicator(Object info, Activity activity,
                Drawable themeImage, int contentDescRes) {
        	return com.actionbarsherlock.drawer.SherlockActionBarDrawerToggleCompat.setActionBarUpIndicator(info, activity,
                    themeImage, contentDescRes);
        }

        @Override
        public Object setActionBarDescription(Object info, Activity activity, int contentDescRes) {
        	return com.actionbarsherlock.drawer.SherlockActionBarDrawerToggleCompat.setActionBarDescription(info, activity,
                    contentDescRes);
        }
    }
    ...
    private static class ActionBarDrawerToggleImplHC implements ActionBarDrawerToggleImpl {
        @Override
        public Drawable getThemeUpIndicator(Activity activity) {
            return com.actionbarsherlock.drawer.SherlockActionBarDrawerToggleHoneycomb.getThemeUpIndicator(activity);
        }

        @Override
        public Object setActionBarUpIndicator(Object info, Activity activity,
                Drawable themeImage, int contentDescRes) {
            return com.actionbarsherlock.drawer.SherlockActionBarDrawerToggleHoneycomb.setActionBarUpIndicator(info, activity,
                    themeImage, contentDescRes);
        }

        @Override
        public Object setActionBarDescription(Object info, Activity activity, int contentDescRes) {
            return com.actionbarsherlock.drawer.SherlockActionBarDrawerToggleHoneycomb.setActionBarDescription(info, activity,
                    contentDescRes);
        }
    }

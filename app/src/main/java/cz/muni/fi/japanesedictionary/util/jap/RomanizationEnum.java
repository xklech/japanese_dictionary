...
public enum RomanizationEnum {
	...
	private final ConcurrentMap<String, String> katakanaToRomaji = new ConcurrentHashMap<>();
	private final ConcurrentMap<String, String> hiraganaToRomaji = new ConcurrentHashMap<>();
	private final ConcurrentMap<String, String> romajiToKatakana = new ConcurrentHashMap<>();
	private final ConcurrentMap<String, String> romajiToHiragana = new ConcurrentHashMap<>();
	...
	private final static Set<String> DOUBLED_CONSONANTS = new HashSet<>(
	...
	private static boolean isDoubledConsonant(final String str) {
		...
		return DOUBLED_CONSONANTS.contains(str.toLowerCase(Locale.getDefault()));
	}
